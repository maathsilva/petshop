  ...
  return (
    <section className="bg-[#FDF6ec] py-16">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-4xl font-bold mb-12 text-purple-700">Serviços</h2>
            ...
            <div className='flex'>
              {services.map((item, index) => (
                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                  <article className="bg-purple-700 text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className='border-t border-white pt-4 flex items-center justify-between'>
                      ...
                      <a
                        target='_blank'
                        href={`https://wa.me/5511981614133?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`}
                        className='flex items-center justify-center gap-2 hover:bg-green-500 px-4 py-1 rounded-md duration-300 font-semibold'
                      >
